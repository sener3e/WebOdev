...
namespace EfCore1C.Controllers
{
    public class KitapController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("KitapID,KitapAd,YazarID")] Kitap kitap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("KitapID,KitapAd,YazarID")] Kitap kitap)
        {
            if (id != kitap.KitapID)
            {
                return NotFound();
